      ...
      <div className={`app sidebar-mini rtl ${sidebarOpen ? 'pace-done sidenav-toggled' : 'pace-done'}`} ref={sidebarRef}>
        ...
        <aside className="app-sidebar">
          ...
          <ul className="app-menu">
            <li><a className="app-menu__item haha" href="/faculty/home"><i className='app-menu__icon bx bx-id-card'></i>
              <span className="app-menu__label">Bảng Điều Khiển</span></a></li>
            <li><a className="app-menu__item " href="/faculty/profile"><i className='app-menu__icon bx bx-id-card'></i> <span
              className="app-menu__label">Thông tin cá nhân</span></a></li>
            <li><a className="app-menu__item" href="/faculty/createTest"><i className='app-menu__icon bx bx-calendar-check'></i><span
              className="app-menu__label">Tạo Bài Kiểm Tra</span></a></li>
            <li><a className="app-menu__item" href="/faculty/uploadMarks"><i className='app-menu__icon bx bx-user-voice'></i><span
              className="app-menu__label">Điểm</span></a></li>
